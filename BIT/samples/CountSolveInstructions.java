...
public class CountSolveInstructions {
        ...
        for (int i = 0; i < infilenames.length; i++) {
            ...
            if (infilename.endsWith(".class")) {
                ...
                for (Enumeration e = ci.getRoutines().elements(); e.hasMoreElements(); ) {
					...
					routine.addBefore("CountSolveInstructions", "mcount", new Integer(1));
                    
                    for (Enumeration b = routine.getBasicBlocks().elements(); b.hasMoreElements(); ) {
                        BasicBlock bb = (BasicBlock) b.nextElement();
			
			String name = routine.getMethodName();
                        bb.addBefore("CountSolveInstructions", "count", new Integer(bb.size()));
                        bb.addBefore("CountSolveInstructions", "methodName", name);
			bb.addBefore("CountSolveInstructions", "exitWrite", 1); 
                    }
                }
            }
        }
    ...
    public static synchronized void printCountSolveInstructions(String foo) {
